...
function inputCheck() {
    ...
    if (k == 3) {
        ...
        document.getElementById("ryokin_sum").innerHTML = kosu[0] * tanka[0] + kosu[1] * tanka[1] + kosu[2] * tanka[2] + " 円";
    } else {
...
function get_kosu(n) {
    ...
    if (kosu == '') {
        ...
        if (kosu > 0) {
            document.getElementById("ryokin" + n).innerHTML = kosu * tanka[n-1] + ' 円';
